...
```{r example3, results=FALSE, fig.path="man/figures/", eval = FALSE}
...
- `mapsf`, a New Package for Thematic Mapping, useR 2021! - [Video](https://youtu.be/8PMF7cBBH7k?t=2621) - [Slides](https://rcarto.github.io/user2021/)
