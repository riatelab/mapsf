...
- x:
  ...
  an sf object (the first row is used), a couple of coordinates (c(x,
  y)), a position (one of 'topleft', 'top','topright', 'right',
  'bottomright', 'bottom', 'bottomleft', 'left'), or "interactive" for
...
- pos:
  ...
  position of the text relative to `x` (one of 'center', 'topleft',
  'top', 'topright', 'right', 'bottomright', 'bottom', 'bottomleft',
  'left'). Ignored if `x` is a position.
...
- line:
  ...
  type of the line drawn between the text and `x`. 0 for no line, 1 for
  a straight line, 2 for a line with an angle, 3 for a curved line.
