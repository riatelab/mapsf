...
#'
#' Many parameters are available to fine tune the cartographic representations.
#' These parameters are the common ones found in GIS and automatic cartography
#' tools such as  classification and color palettes used in choropleth maps,
#' or symbols sizes and shapes used in proportional symbols maps.
#'
