...
```{r target, fig.height=5.71, fig.width=6, results = FALSE}
library(mapsf)
# set margins theme
...
```{r target_plus, fig.height=5.71, fig.width=6, results = FALSE}
# set a theme
mf_theme("sol_dark")
# Selection of a target municipality to display in the inset
mtq_target <- mtq[c(26), ]
...
```{r fig_par, fig.height=6, fig.width=5, results = FALSE}
# set a theme
...
```{r worldmap, fig.height=6, fig.width=5, results = FALSE}
mf_map(mtq)
...
```{r non_carto, fig.height=7.58, fig.width=6.25, results = FALSE}
# create classes
