...
```{r target, fig.height=5.71, fig.width=6, results = FALSE, fig.alt="A map with an inset in the topright corner"}
library(mapsf)
# set margins theme
...
```{r target_plus, fig.height=5.71, fig.width=6, results = FALSE, fig.alt="A map with a complex inset"}
# set a theme
mf_theme("sol_dark")
# Selection of a target municipality to display in the inset
mtq_target <- mtq[c(26), ]
...
```{r fig_par, fig.height=6, fig.width=5, results = FALSE, fig.alt = "A map with an inset at a specific location"}
# set a theme
...
```{r worldmap, fig.height=6, fig.width=5, results = FALSE, fig.alt = "A map with a world map inset"}
mf_map(mtq)
...
```{r non_carto, fig.height=7.58, fig.width=6.25, results = FALSE, fig.alt="A map with a non-cartographic inset"}
# create classes
