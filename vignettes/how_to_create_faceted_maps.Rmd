...
```{r side_by_side, fig.height=4, fig.width=7, results = FALSE, fig.alt="Two maps on the same figure"}
library(mapsf)
mtq <- mf_get_mtq()
...
```{r six_by_six, fig.height = 8, fig.width = 7, results = FALSE, fig.alt= "A figure with a map for each municipality, organised 6 by 6"}
